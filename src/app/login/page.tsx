...
export default function LoginPage() {
    return (
        <Suspense fallback={<div className="flex min-h-screen items-center justify-center bg-[#0B0B0F] text-[#F4F4F5]"><Loader2 className="h-10 w-10 animate-spin text-[#A855F7]" /></div>}>
            <LoginContent />
        </Suspense>
    );
}
